...
public class XyzTilemapConfiguration {
	...
	public static XyzTilemapConfiguration readConfig(String filename) throws JSONException {
		createTerrainMapping();

		JSONObject terrainDesc = JsonHelper.readJsonFromAsset(filename);
		XyzTilemapConfiguration ret = new XyzTilemapConfiguration();
