...
public class Badges {
	...
	public enum Badge {
		...
		MONSTERS_SLAIN_3(R.string.Badges_MonsterSlain3, 2),
		MONSTERS_SLAIN_4(R.string.Badges_MonsterSlain4, 3),
		MONSTERS_SLAIN_5(R.string.Badges_MonsterSlain5, 73),

		GOLD_COLLECTED_1(R.string.Badges_GoldColleted1, 4),
		GOLD_COLLECTED_2(R.string.Badges_GoldColleted2, 5),
		GOLD_COLLECTED_3(R.string.Badges_GoldColleted3, 6),
		GOLD_COLLECTED_4(R.string.Badges_GoldColleted4, 7),
		GOLD_COLLECTED_5(R.string.Badges_GoldCollected5, 74),

		LEVEL_REACHED_1(R.string.Badges_LevelReached1, 8),
		LEVEL_REACHED_2(R.string.Badges_LevelReached2, 9),
		LEVEL_REACHED_3(R.string.Badges_LevelReached3, 10),
		LEVEL_REACHED_4(R.string.Badges_LevelReached4, 11),
		LEVEL_REACHED_5(R.string.Badges_LevelReached5, 75),

		ALL_POTIONS_IDENTIFIED(R.string.Badges_AllPotions, 16),
		ALL_SCROLLS_IDENTIFIED(R.string.Badges_AllScrolls, 17),
		ALL_RINGS_IDENTIFIED(R.string.Badges_AllRings, 18),
		ALL_WANDS_IDENTIFIED(R.string.Badges_AllWands, 19),
		ALL_ITEMS_IDENTIFIED(R.string.Badges_AllItems, 35, true),
		...
		BAG_BOUGHT_KEY_RING,
		BAG_BOUGHT_QUIVER,
		ALL_BAGS_BOUGHT(R.string.Badges_AllBags, 23),
		DEATH_FROM_FIRE(R.string.Badges_DeathFire, 24),
		DEATH_FROM_POISON(R.string.Badges_DeathPoison, 25),
		DEATH_FROM_GAS(R.string.Badges_DeathGas, 26),
		DEATH_FROM_HUNGER(R.string.Badges_DeathHunger, 27),
		DEATH_FROM_GLYPH(R.string.Badges_DeathGlyph, 57),
		DEATH_FROM_FALLING(R.string.Badges_DeathFalling, 59),
		YASD(R.string.Badges_Yasd, 34, true),
		BOSS_SLAIN_1_WARRIOR,
		BOSS_SLAIN_1_MAGE,
		BOSS_SLAIN_1_ROGUE,
		BOSS_SLAIN_1_HUNTRESS,
		BOSS_SLAIN_1(R.string.Badges_BossSlain1, 12),
		BOSS_SLAIN_2(R.string.Badges_BossSlain2, 13),
		BOSS_SLAIN_3(R.string.Badges_BossSlain3, 14),
		BOSS_SLAIN_4(R.string.Badges_BossSlain4, 15),
		BOSS_SLAIN_1_ALL_CLASSES(R.string.Badges_BossSlain1All, 32, true),
		...
		BOSS_SLAIN_3_SNIPER,
		BOSS_SLAIN_3_WARDEN,
		BOSS_SLAIN_3_ALL_SUBCLASSES(R.string.Badges_BossSlain3All, 33, true),
		RING_OF_HAGGLER(R.string.Badges_RingHaggler, 20),
		RING_OF_THORNS(R.string.Badges_RingThorns, 21),
		STRENGTH_ATTAINED_1(R.string.Badges_StrengthAttained1, 40),
		STRENGTH_ATTAINED_2(R.string.Badges_StrengthAttained2, 41),
		STRENGTH_ATTAINED_3(R.string.Badges_StrengthAttained3, 42),
		STRENGTH_ATTAINED_4(R.string.Badges_StrengthAttained4, 43),
		STRENGTH_ATTAINED_5(R.string.Badges_StrengthAttained5, 76),

		FOOD_EATEN_1(R.string.Badges_FoodEaten1, 44),
		FOOD_EATEN_2(R.string.Badges_FoodEaten2, 45),
		FOOD_EATEN_3(R.string.Badges_FoodEaten3, 46),
		FOOD_EATEN_4(R.string.Badges_FoodEaten4, 47),
		FOOD_EATEN_5(R.string.Badges_FoodEaten5, 77),
		MASTERY_WARRIOR,
		MASTERY_MAGE,
		MASTERY_ROGUE,
		MASTERY_HUNTRESS,
		ITEM_LEVEL_1(R.string.Badges_ItemLvl1, 48),
		ITEM_LEVEL_2(R.string.Badges_ItemLvl2, 49),
		ITEM_LEVEL_3(R.string.Badges_ItemLvl3, 50),
		ITEM_LEVEL_4(R.string.Badges_ItemLvl4, 51),
		ITEM_LEVEL_5(R.string.Badges_ItemLvl5, 78),
		RARE_ALBINO,
		RARE_BANDIT,
		RARE_SHIELDED,
		RARE_SENIOR,
		...
		RARE_DEEP_SNAIL,
		RARE_SHAMAN_ELDER,
		RARE(R.string.Badges_RareAll, 37, true),
		VICTORY_WARRIOR,
		VICTORY_MAGE,
		VICTORY_ROGUE,
		VICTORY_HUNTRESS,
		VICTORY(R.string.Badges_Victory, 22),
		VICTORY_ALL_CLASSES(R.string.Badges_VictoryAll, 36, true),
		MASTERY_COMBO(R.string.Badges_MasteryCombo, 56),
		POTIONS_COOKED_1(R.string.Badges_PotionsCooked1, 52),
		POTIONS_COOKED_2(R.string.Badges_PotionsCooked2, 53),
		POTIONS_COOKED_3(R.string.Badges_PotionsCooked3, 54),
		POTIONS_COOKED_4(R.string.Badges_PotionsCooked4, 55),
		POTIONS_COOKED_5(R.string.Badges_PotionsCooked5, 79),

		NO_MONSTERS_SLAIN(R.string.Badges_NoMonsterSlain, 28),
		GRIM_WEAPON(R.string.Badges_GrimWepon, 29),
		PIRANHAS(R.string.Badges_Piranhas, 30),
		NIGHT_HUNTER(R.string.Badges_NightHunter, 58),
		GAMES_PLAYED_1(R.string.Badges_GamesPlayed1, 60, true),
		GAMES_PLAYED_2(R.string.Badges_GamesPlayed2, 61, true),
		GAMES_PLAYED_3(R.string.Badges_GamesPlayed3, 62, true),
		GAMES_PLAYED_4(R.string.Badges_GamesPlayed4, 63, true),
		GAMES_PLAYED_5(R.string.Badges_GamesPlayed5, 80, true),
		HAPPY_END(R.string.Badges_HappyEnd, 38),
		CHAMPION(R.string.Badges_Champion, 39, true),
		SUPPORTER(R.string.Badges_Supporter, 31, true),
		IMMURED(R.string.Badges_Immured, 64),
		LICH_SLAIN(R.string.Badges_Lich_Slain, 69),
		ICE_GUARDIAN_SLAIN(R.string.Badges_Ice_Guardian_Slain, 70),
		SPIDER_QUEEN_SLAIN(R.string.Badges_SpiderQueen_Slain, 66),
		SHADOW_LORD_SLAIN(R.string.Badges_ShadowLord_Slain, 67),
		YOG_SLAIN(R.string.Badges_Yog_Slain, 65),
		DEATH_FROM_NECROTISM(R.string.Badges_DeathNecrotism, 71),
		...
		Badge(int desc_id, int image) {
			this(StringsManager.getVar(desc_id), image);
		}

		Badge(int desc_id, int image, boolean meta) {
			this(StringsManager.getVar(desc_id), image, meta);
		}
	...
	public static void validateRare(Mob mob) {
		...
		} else if (mob.getEntityKind().equals(MobFactory.SENIOR)) {
	...
	public static void validateBadge(Badge badge) {
