...
/**
 * HTML version of KeyEvent class
 */
public class KeyEvent {
    public static final int KEYCODE_BACK = Input.Keys.ESCAPE;
    public static final int KEYCODE_MENU = Input.Keys.MENU;
    public static final int KEYCODE_VOLUME_UP = Input.Keys.PLUS;
    public static final int KEYCODE_VOLUME_DOWN = Input.Keys.MINUS;
