...
public class WelcomeScene extends PixelScene {
    ...
    public void create() {
        ...
        Text text_21_1 = createMultiline(TXT_Welcome_21_1, 8);
        ...
        text_21_1.maxWidth((int) panel.innerWidth());
        ...
        text_21_1.setPos(0,  text.height()+text_19.height() + text_20.height() + text_20_1.height() +text_21.height() + 5*GAP);
        ...
        content.add(text_21);
        content.add(text_21_1);

        content.setSize( panel.innerWidth(), text.height() + text_19.height() + text_20.height() + text_20_1.height()+text_21.height()+text_21_1.height()+ 5*GAP );
