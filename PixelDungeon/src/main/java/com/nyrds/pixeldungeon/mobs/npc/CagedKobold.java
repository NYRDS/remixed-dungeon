...
public class CagedKobold extends NPC {
	...
	private static final String TXT_QUEST_START = Game.getVar(R.string.CagedKoboldNPC_Intro);
	private static final String TXT_QUEST_END = Game.getVar(R.string.CagedKoboldNPC_Quest_End);
